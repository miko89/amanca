...
# Example usage
weather_file = r'E:\amanca\data\presentweather-jakarta.csv'
location_file = r'E:\amanca\data\kecamatan_geofeatures.csv'
output_file = r'E:\amanca\data\merged_data_jakarta_ps.csv'
...
# Example usage
csv_file_path = r'E:\amanca\data\merged_data_jakarta_ps.csv'
json_file_path = r'E:\amanca\data\outputjakarta_ps.json'
