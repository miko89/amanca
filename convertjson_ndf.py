...
def main():
    weather_files = [
        r'E:\amanca\data\kecamatanforecast-banten.csv',
        r'E:\amanca\data\kecamatanforecast-jakarta.csv',
        r'E:\amanca\data\kecamatanforecast-jawabarat.csv'
    ]
    ...
    json_files = [
        ...
        r'E:\amanca\data\outputjakarta.json',
        r'E:\amanca\data\outputjabar.json'
    ]
