...
# Example usage
weather_file = r'E:\amanca\data\kecamatanforecast-banten.csv'
location_file = r'E:\amanca\data\kecamatan_geofeatures.csv'
output_file = r'E:\amanca\data\merged_data_banten.csv'
...
# Example usage
csv_file_path = r'E:\amanca\data\merged_data_banten.csv'
json_file_path = r'E:\amanca\data\outputbanten.json'
